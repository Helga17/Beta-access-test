...
const AccessPage = (props) => {
    ...
    const onSubmit = (event) => {
        let findCode = codesData.find(item => item.code === codeValue);
    ...
    return (
        <div className="container">
            ...
            {!props.currentUser &&
            <div className="box">
                <input type="text" className="form-control" value={codeValue} onChange={inputChange} placeholder="Enter the code" />
